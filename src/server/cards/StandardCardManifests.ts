...
export const BASE_CARD_MANIFEST = new ModuleManifest({
  ...
  projectCards: {
    ...
    [CardName.AEROBRAKED_AMMONIA_ASTEROID]: {
      Factory: AerobrakedAmmoniaAsteroid,
    },
    ...
    [CardName.BEAM_FROM_A_THORIUM_ASTEROID]: {
      Factory: BeamFromAThoriumAsteroid,
    },
  ...
  corporationCards: {
    ...
    [CardName.UNITED_NATIONS_MARS_INITIATIVE]: {
      Factory: UnitedNationsMarsInitiative,
    },
  },
  standardProjects: {
    ...
    [CardName.POWER_PLANT_STANDARD_PROJECT]: {
      Factory: PowerPlantStandardProject,
    },
    ...
    [CardName.SELL_PATENTS_STANDARD_PROJECT]: {
      Factory: SellPatentsStandardProject,
    },
  },
  standardActions: {
...
export const CORP_ERA_CARD_MANIFEST = new ModuleManifest({
  ...
  projectCards: {
    ...
    [CardName.ASTEROID_MINING_CONSORTIUM]: {
      Factory: AsteroidMiningConsortium,
    },
    ...
    [CardName.GREAT_ESCARPMENT_CONSORTIUM]: {
      Factory: GreatEscarpmentConsortium,
    },
