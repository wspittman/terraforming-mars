...
import { Livestock } from '@/server/cards/base/Livestock';
...
describe('ProtectedHabitats', () => {
  it('Should play', () => {
    ...
    const first = RemoveResourcesFromCard.getAvailableTargetCards(
      player3,
      CardResource.ANIMAL,
    );
    ...
    const second = RemoveResourcesFromCard.getAvailableTargetCards(
      player3,
      CardResource.ANIMAL,
    );
